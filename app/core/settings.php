...
// Utilidades
define('CSS_FRAMEWORK', 'bl');   // opciones disponibles: bs o bs5 = Bootstrap 5 | bl = Bulma | fn = Foundation
...
define('LIGHTBOX'     , true);  // define si es requerido Lightbox
...
define('SITE_NAME'   , 'PewPew');    // Nombre del sitio
